...
public class StringFunctionTests extends TestBase {
    ...
    public void testContainsStringString() throws Exception {
        ...
        polyad.setOperatorType(FunctionEvaluator.CONTAINS_TYPE);
    ...
    public void testContainsStringStem() throws Exception {
        ...
        Polyad polyad = new Polyad(testUtils.getOpEvaluator(), testUtils.getFunctionEvaluator());
        VariableNode left = new VariableNode("source", symbolTable);
        VariableNode right = new VariableNode("snippets.", symbolTable);
    ...
    public void testContainsStemString() throws Exception {
        ...
        Polyad polyad = new Polyad(testUtils.getOpEvaluator(), testUtils.getFunctionEvaluator());
        VariableNode left = new VariableNode("sourceStem.", symbolTable);
        VariableNode right = new VariableNode("targetString", symbolTable);
    ...
    public void testContainsStemStem() throws Exception {
        ...
        Polyad polyad = new Polyad(testUtils.getOpEvaluator(), testUtils.getFunctionEvaluator());
        VariableNode left = new VariableNode("sourceStem.", symbolTable);
        VariableNode right = new VariableNode("targetStem.", symbolTable);
    ...
    public void testStringTrim() throws Exception {
        ...
        Polyad polyad = new Polyad(testUtils.getOpEvaluator(), testUtils.getFunctionEvaluator());
        VariableNode left = new VariableNode("arg", symbolTable);

        polyad.setOperatorType(FunctionEvaluator.TRIM_TYPE);
        polyad.addArgument(left);
        polyad.evaluate();
    ...
    public void testStemTrim() throws Exception {
        ...
        Polyad polyad = new Polyad(testUtils.getOpEvaluator(), testUtils.getFunctionEvaluator());
        VariableNode left = new VariableNode("stem.", symbolTable);
    ...
    public void testIndexOfStringString() throws Exception {
        ...
        ConstantNode left = new ConstantNode("abcdef", Constant.STRING_TYPE);
        ConstantNode right = new ConstantNode("de", Constant.STRING_TYPE);
        polyad.setOperatorType(FunctionEvaluator.INDEX_OF_TYPE);
        polyad.addArgument(left);
        polyad.addArgument(right);
        polyad.evaluate();
    ...
    public void testStringToUpper() throws Exception {
        ...
        polyad.setOperatorType(FunctionEvaluator.TO_UPPER_TYPE);
        polyad.addArgument(left);
        polyad.evaluate();
        assert polyad.getResult().equals(result);
    ...
    public void testStringToLower() throws Exception {
        ...
        polyad.setOperatorType(FunctionEvaluator.TO_LOWER_TYPE);
        polyad.addArgument(left);
        polyad.evaluate();
        assert polyad.getResult().equals(result);
    ...
    public void testAllStringReplace() throws Exception {
        ...
        polyad.setOperatorType(FunctionEvaluator.REPLACE_TYPE);
    ...
    public void testStemStringReplace() throws Exception {
        ...
        Polyad polyad = new Polyad(testUtils.getOpEvaluator(), testUtils.getFunctionEvaluator());
        VariableNode source = new VariableNode("sourceStem.", symbolTable);
        VariableNode old = new VariableNode("targetStem.", symbolTable);
    ...
    public void testInsertStringString() throws Exception {
        ...
        polyad.setOperatorType(FunctionEvaluator.INSERT_TYPE);
        polyad.addArgument(left);
        polyad.addArgument(right);
    ...
    public void testInsertStemStem() throws Exception {
        ...
        Polyad polyad = new Polyad(testUtils.getOpEvaluator(), testUtils.getFunctionEvaluator());
        VariableNode left = new VariableNode("sourceStem.", symbolTable);
        VariableNode snippetVar = new VariableNode("snippets.", symbolTable);
        VariableNode indexVar = new VariableNode("indices.", symbolTable);
