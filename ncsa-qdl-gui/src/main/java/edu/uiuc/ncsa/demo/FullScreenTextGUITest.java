...
/**
 * Taken from an example on the Lanterna website (from old release). Puts up non-functional screen of
 * items you can navigate, prints status line while you do it. Escape exits. Nifty and pretty small.
 *
 */
public class FullScreenTextGUITest {
    ...
    private static class BIOS extends Panel {
        ...
        protected ComponentRenderer<Panel> createDefaultRenderer() {
            final Panel.DefaultPanelRenderer panelRenderer = (DefaultPanelRenderer)super.createDefaultRenderer();
